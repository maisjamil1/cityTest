...
//       const locationData = new Location(city, geoData);
//       // console.log('location',request.query);//{ city: 'amman' }
...
//     )
//       .then((weatherRes) => {
//         // console.log('weather',request.query);//{search_query:,formatted_query:,latitude:,longitude:}
...
//         // console.log('hiking',request.query);//{search_query:,formatted_query:,latitude:,longitude:}
...
//             // console.log('movies',request.query);//{search_query:,formatted_query:,latitude:,longitude:}
